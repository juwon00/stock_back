...
# 2017-10-01 ~ 2024-03-29 까지의 데이터 수집
...
#     print(time_30_arr[i], open_arr[i], high_arr[i], low_arr[i], close_arr[i], volume_arr[i])

result = np.vstack((time_30_arr, open_arr, high_arr, low_arr, close_arr, volume_arr))
print(result)
